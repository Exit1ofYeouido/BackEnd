...
public class LogService {
    ...
    public List<GetHistoryStockResponseDto> gethistoryStock(String role, String enterpriseName, String year,
    ...
    private List<GetHistoryStockResponseDto> getFinalDto(Map<String, Integer> sortedsearch,
